...
/*
Implemente uma função que ao receber um array associativo contendo arquivos e donos,
retorne os arquivos agrupados por dono. 
...
class FileOwners
{
    public static function groupByOwners($files)
    {
        ...
        foreach ($files as $fileName => $ownerName) {
            $filesGrouped[$ownerName][] = $fileName;
        }
